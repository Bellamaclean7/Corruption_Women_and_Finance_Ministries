...
gen changeXpres = corr_change*presidential
	...
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag  presidential   accountability 	
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag  presidential if  accountability==1 	
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag   if  accountability==0 	
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag  presidential   accountability changeXacc 
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag       if  accountability==1 & presidential==1
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag       if  accountability==1 & presidential==0
	logit femaleminister corr_change date  gdppercapita_lag loggdp_lag  unified    womenrep_lag  presidential  changeXpres   if  accountability==1 
